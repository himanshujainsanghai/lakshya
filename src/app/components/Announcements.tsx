  ...
  return (
    <div className="bg-white p-4 rounded-md">
      ...
      <div className="flex flex-col gap-4 mt-4">
        {data[0] && (
          <div className="bg-mybluelight rounded-md p-4">
            <div className="flex items-center justify-between">
            ...
            <p className="text-sm font-gray-400 mt-2">{data[0].description}</p>
          </div>
        )}
        ...
        {data[1] && (
          <div className="bg-mypurplelight rounded-md p-4">
            ...
            <p className="text-sm font-gray-400 mt-2">{data[1].description}</p>
          </div>
        )}
        {data[2] && (
          <div className="bg-myYellowlight rounded-md p-4">
            ...
            <p className="text-sm font-gray-400 mt-2">{data[2].description}</p>
          </div>
        )}
      </div>
    </div>
